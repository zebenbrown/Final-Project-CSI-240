...
int main(int argc, char* argv[]) {
    ...
    (void) argv;
        ...
        // todo add otherteams
        std::vector<std::string> teamsStr = {"ARI", "COL", "SF", "LAD", "SD",
                                             "CHC", "STL", "CIN", "PIT", "MIL",
                                             "NYM", "ATL", "MIA", "WSH", "PHI",
                                             "SEA", "HOU", "TEX", "OAK", "LAA",
                                             "CHW", "MIN", "DET", "CLE", "KC",
                ...
                if (show_another_window) {
                    ...
                    if (ImGui::CollapsingHeader("Teams"))
                    {
                        for (auto [teamID, teamRoster] : TeamMap){
                            ...
                            //ImGui::Text(tname.c_str());
                            if (ImGui::CollapsingHeader(tname.c_str())){
                                for(auto p : teamRoster){
                                    std::string pname = p["longName"];
                                    std::string position = p["pos"];
                                    if (position == "P" && !p["stats"].empty()){
                                        std::string whip = p["stats"]["Pitching"]["WHIP"];
                                        ImGui::Text("Name:");
                                        ImGui::SameLine();
                                        ...
                                        ImGui::Text("WHIP:");
                                        ImGui::SameLine();
                                        ImGui::Text(whip.c_str());
                                    }
                                    else if (position != "P" && !p["stats"].empty())
                                    {
                                        std::string battingAverage = p["stats"]["Hitting"]["avg"];
                                        ImGui::Text("Name:");
                                        ImGui::SameLine();
                                        ImGui::Text(pname.c_str());
                                        ImGui::SameLine();
                                        ...
                                        ImGui::Text(position.c_str());
                                        ImGui::SameLine();
                                        ImGui::Text("Batting Average:");
                                        ImGui::SameLine();
                                        ImGui::Text(battingAverage.c_str());
                                    }
                                    else{
                                        ImGui::Text("Name:");
                                        ImGui::SameLine();
